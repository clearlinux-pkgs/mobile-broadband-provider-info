...
Source0  : https://download.gnome.org/sources/mobile-broadband-provider-info/20240407/mobile-broadband-provider-info-20240407.tar.xz
...
%prep
%setup -q -n mobile-broadband-provider-info-20240407
cd %{_builddir}/mobile-broadband-provider-info-20240407
pushd ..
cp -a mobile-broadband-provider-info-20240407 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714666809
